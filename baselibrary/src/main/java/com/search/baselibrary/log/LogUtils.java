package com.search.baselibrary.log;
 ...
 *     time  : 2016/9/21
 *     desc  : 日志相关工具类
 *            https://juejin.im/entry/58d8d3011b69e6006bbdc5c1
 * </pre>
 */
    ...
    public static class Builder {
        ...
        public Builder() {
            if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())) {
                dir = UiUtils.getContext().getExternalCacheDir() + File.separator + "log" + File.separator;
            } else {
                dir = UiUtils.getContext().getCacheDir() + File.separator + "log" + File.separator;
            }
        }
